    ...
    describe ".determine_path" do
      ...
      context "when the left path is enabled" do
        ...
        it "returns the result of the left path" do
          expect(path_brancher.determine_path(path_name, call_metadata, left_path, right_path)).to eq("Left Path Called")
        end
      end
      ...
      context "when the left path is disabled" do
        ...
        it "returns the result of the right path" do
          expect(path_brancher.determine_path(path_name, call_metadata, left_path, right_path)).to eq("Right Path Called")
        end
      end
    end
end